...
const Page = () => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-gradient-to-b from-[#020084] to-[#000149] flex flex-col items-center py-16 px-4">
      ...
      ></div>
      <div className="mt-20 rounded-lg bg-gray-800/30 backdrop-blur-sm border border-white/10 py-10 shadow-2xl">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2 md:pl-12" data-aos="fade-left">
            ...
            Our treasury team, led by Prithviraj K P, ensures efficient financial management of the club. We handle all monetary aspects with utmost transparency and accountability.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-white mb-2 font-[Khand]">Budget Management</h3>
                <p className="text-gray-400 font-[GMVF]">Planning and allocating resources for club activities and events.</p>
              </div>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-white mb-2 font-[Khand]">Financial Records</h3>
                <p className="text-gray-400 font-[GMVF]">Maintaining accurate documentation of all financial transactions.</p>
              </div>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-white mb-2 font-[Khand]">Financial Planning</h3>
                <p className="text-gray-400 font-[GMVF]">Strategic planning for long-term financial sustainability.</p>
              </div>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-white mb-2 font-[Khand]">Sponsorship Management</h3>
                <p className="text-gray-400 font-[GMVF]">Handling sponsorships and financial partnerships effectively.</p>
              </div>
            </div>
          </div>
        </div>
