...
const Page = () => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-gradient-to-b from-[#020084] to-[#000149] flex flex-col items-center py-16 px-4">
      ...
      <div className="container mx-auto px-4 z-10 max-sm:mt-10 rounded-lg bg-gray-800/30 backdrop-blur-sm border border-white/10  shadow-2xl p-4">
        <h2 className="text-3xl font-bold text-center bg-clip-text font-[Excon] text-transparent bg-gradient-to-r from-blue-400 to-purple-400 mb-12 " data-aos="fade-up">
          Meet Our Leads
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="relative bg-gray-800/60 backdrop-blur-lg rounded-xl p-8 text-center shadow-lg border-2 border-blue-500/20 hover:border-blue-500/40 transition-all duration-300">
            ...
            <div className="text-center mb-6">
              <h1 className="text-4xl font-bold text-white font-[Khand]">Rithvik</h1>
              <p className="text-white text-lg font-medium font-[Khand]">Technical Team Lead</p>
            </div>
          ...
          <div className="relative bg-gray-800/60 backdrop-blur-lg rounded-xl p-8 text-center shadow-lg border-2 border-blue-500/20 hover:border-blue-500/40 transition-all duration-300">
            ...
            {/* Name and Title */}
            <div className="text-center mb-6">
              <h1 className="text-4xl font-bold text-white font-[Khand]">Nikhil Kumar</h1>
              <p className="text-white text-lg font-medium font-[Khand]">Technical Team Lead</p>
            </div>
          ...
          <div className="relative bg-gray-800/60 backdrop-blur-lg rounded-xl p-8 text-center shadow-lg border-2 border-blue-500/20 hover:border-blue-500/40 transition-all duration-300">
            ...
            {/* Name and Title */}
            <div className="text-center mb-6">
              <h1 className="text-4xl font-bold text-white font-[Khand]">G Jayaditya</h1>
              <p className="text-white text-lg font-medium font-[Khand]">Technical Team Lead</p>
            </div>
          ...
          <div className="md:w-1/2 md:pl-12" data-aos="fade-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-white mb-2 font-[Khand]">Website Development</h3>
                <p className="text-gray-400 font-[GMVF]">Crafting seamless digital experiences through modern web technologies.</p>
              </div>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-white mb-2 font-[Khand]">Backbone of Events</h3>
                <p className="text-gray-400 font-[GMVF]">Ensuring flawless technical execution of all club events.</p>
              </div>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-white mb-2 font-[Khand]">Technical Workshops</h3>
                <p className="text-gray-400 font-[GMVF]">Conducting hands-on sessions on cutting-edge technologies.</p>
              </div>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-white mb-2 font-[Khand]">Innovation Hub</h3>
                <p className="text-gray-400 font-[GMVF]">Fostering creativity and technical innovation within the community.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="team-card bg-gray-800/60 backdrop-blur-lg rounded-xl p-8 text-center" data-aos="fade-up">
          <Image 
            ...
            height={128} 
          />
          <h3 className="text-xl font-semibold mb-4 text-white font-[Khand]">Guru Swarupa</h3>
        ...
        <div className="team-card bg-gray-800/60 backdrop-blur-lg rounded-xl p-8 text-center" data-aos="fade-up" data-aos-delay="100">
          <Image 
            ...
            height={128} 
          />
          <h3 className="text-xl font-semibold mb-4 text-white font-[Khand]">Chintu Rai</h3>
          <div className="flex justify-center space-x-6">
            <a href="https://www.linkedin.com/in/chinturai/" className="social-icon text-gray-500 hover:text-blue-300">
              <FaLinkedin size={24}/>
            </a>
        ...
        <div className="team-card bg-gray-800/60 backdrop-blur-lg rounded-xl p-8 text-center" data-aos="fade-up" data-aos-delay="200">
          <Image 
            ...
            height={128} 
          />
          <h3 className="text-xl font-semibold mb-4 text-white font-[Khand]">Sreejith S</h3>
          <div className="flex justify-center space-x-6">
            <a href="https://www.linkedin.com/in/sreejith-s-b232092a9/" className="social-icon text-gray-500 hover:text-blue-300">
              <FaLinkedin size={24}/>
            </a>
        ...
        <div className="team-card bg-gray-800/60 backdrop-blur-lg rounded-xl p-8 text-center" data-aos="fade-up" data-aos-delay="100">
          <Image 
            ...
            height={128} 
          />
          <h3 className="text-xl font-semibold mb-4 text-white font-[Khand]">Sahina Parbin</h3>
          <div className="flex justify-center space-x-6">
            <a href="https://www.linkedin.com/in/sahinaparbin/" className="social-icon text-gray-500 hover:text-blue-300">
              <FaLinkedin size={24}/>
            </a>
            <a href="https://www.instagram.com/s4hinaura?igsh=YzljYTk1ODg3Zg==" className="social-icon text-gray-500 hover:text-pink-300">
              <FaInstagram size={24}/>
            </a>
          </div>
        </div>
        ...
        <div className="team-card bg-gray-800/60 backdrop-blur-lg rounded-xl p-8 text-center" data-aos="fade-up" data-aos-delay="100">
          <Image 
            ...
            height={128} 
          />
          <h3 className="text-xl font-semibold mb-4 text-white font-[Khand]">Anik Tiwary</h3>
          <div className="flex justify-center space-x-6">
            <a href="https://www.linkedin.com/in/anik-tiwary-4a1161292?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="social-icon text-gray-500 hover:text-blue-300">
              <FaLinkedin size={24}/>
            </a>
            <a href="https://www.instagram.com/anik_tiwary08/" className="social-icon text-gray-500 hover:text-pink-300">
              <FaInstagram size={24}/>
            </a>
          </div>
        </div>
        ...
        <div className="team-card bg-gray-800/60 backdrop-blur-lg rounded-xl p-8 text-center" data-aos="fade-up" data-aos-delay="100">
          <Image 
            ...
            height={128} 
          />
          <h3 className="text-xl font-semibold mb-4 text-white font-[Khand]">Arjun Dev</h3>
          <div className="flex justify-center space-x-6">
            <a href="https://www.linkedin.com/in/arjundev2005/" className="social-icon text-gray-500 hover:text-blue-300">
              <FaLinkedin size={24}/>
            </a>
            {/* <a href="https://www.instagram.com/iamchinturai?igsh=YzljYTk1ODg3Zg==" className="social-icon text-gray-500 hover:text-pink-300">
              <FaInstagram size={24}/>
