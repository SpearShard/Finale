...
const Page = () => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-gradient-to-b from-[#020084] to-[#000149] flex flex-col items-center py-16 px-4">
      ...
      {/* Profile Section */}
      <div className="relative bg-gray-800/60 backdrop-blur-lg rounded-xl p-8 shadow-2xl border border-white/10 max-sm:mt-10">
  {/* Profile Image */}
  ...
  <div className="text-center mb-6 ">
    ...
    <p className="text-gray-300 text-lg font-medium font-[Khand]">Marketing Team Lead</p>
  </div>
          ...
          <div className="md:w-1/2 md:pl-12" data-aos="fade-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-white mb-2 font-[Khand]">Campaign Strategy</h3>
                <p className="text-gray-400 font-[GMVF]">Developing and executing targeted marketing campaigns.</p>
              </div>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-white mb-2 font-[Khand]">Partnerships</h3>
                <p className="text-gray-400 font-[GMVF]">Building relationships with sponsors and partner organizations.</p>
              </div>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-white mb-2 font-[Khand]">Outreach Programs</h3>
                <p className="text-gray-400 font-[GMVF]">Organizing events and initiatives to expand our community.</p>
              </div>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-white mb-2 font-[Khand]">Market Research</h3>
                <p className="text-gray-400 font-[GMVF]">Analyzing trends and opportunities for growth.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="team-card bg-gray-800/60 backdrop-blur-lg rounded-xl p-8 text-center" data-aos="fade-up">
          <Image 
            ...
            height={128} 
          />
          <h3 className="text-xl font-semibold mb-4 text-white font-[Khand]">Anarghya Gunashekaran</h3>
          <div className="flex justify-center space-x-6">
            <a href="https://www.linkedin.com/in/anarghya-gunashekaran-0a06bb331?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="social-icon text-gray-500 hover:text-blue-300">
              <FaLinkedin size={24}/>
            </a>
            <a href="https://www.instagram.com/ag25114/profilecard/?igsh=MWt0NTJ3ZHFjcG82eQ==" className="social-icon text-gray-500 hover:text-pink-300">
              <FaInstagram size={24}/>
            </a>
          </div>
        </div>
        ...
        <div className="team-card bg-gray-800/60 backdrop-blur-lg rounded-xl p-8 text-center" data-aos="fade-up" data-aos-delay="100">
          <Image 
            ...
            height={128} 
          />
          <h3 className="text-xl font-semibold mb-4 text-white font-[Khand]">Neelakshi Yemde</h3>
          <div className="flex justify-center space-x-6">
            <a href="https://www.linkedin.com/in/neelakshi-yemde-3b4743306/" className="social-icon text-gray-500 hover:text-blue-300">
              <FaLinkedin size={24}/>
            </a>
            <a href="https://www.instagram.com/ny._.neelsy?igsh=MWRhbjZ6endmeDlsMA==" className="social-icon text-gray-500 hover:text-pink-300">
              <FaInstagram size={24}/>
            </a>
          </div>
        </div>
        ...
        <div className="team-card bg-gray-800/60 backdrop-blur-lg rounded-xl p-8 text-center" data-aos="fade-up" data-aos-delay="200">
          <Image 
            ...
            height={128} 
          />
          <h3 className="text-xl font-semibold mb-4 text-white font-[Khand]">Tejas R Mutalik</h3>
          <div className="flex justify-center space-x-6">
            <a href="https://www.linkedin.com/in/tejas-r-mutalik-b03214299/" className="social-icon text-gray-500 hover:text-blue-300">
              <FaLinkedin size={24}/>
            </a>
            <a href="https://www.instagram.com/trm_3113/" className="social-icon text-gray-500 hover:text-pink-300">
              <FaInstagram size={24}/>
            </a>
          </div>
        </div>
